grammar SimScan_ANTLR3;@header {package org.atl.engine.injectors.ebnf;}@lexer::header {package org.atl.engine.injectors.ebnf;}@lexer::members {
...
simScan returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("SimScan", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	(((((temp=sSGroup {ei.set(ret, "groups", temp);} ((temp=sSGroup {ei.set(ret, "groups", temp);}))*))?)))
  {
...
sSGroup returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("SSGroup", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	(((temp=sSUnit {ei.set(ret, "units", temp);} (((COMA) temp=sSUnit {ei.set(ret, "units", temp);}))*)))
  {
   ei.leaveContext(false);
   if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.atl.engine.injectors.ebnf.LocationTokenv3)input.LT(-1)).getEndLine() + ":" + (((org.atl.engine.injectors.ebnf.LocationTokenv3)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
	   ei.setCommentsAfter(ret, new Object[] {input, input.LT(-1)});
...
sSUnit returns[Object ret2] @init {Object ret=(backtracking==0) ? ei.create("SSUnit", false, false) : null;org.antlr.runtime.Token firstToken=input.LT(1);}
	:	(temp=integerSymbol {ei.set(ret, "nodeNo", temp);} MINUS temp=identifier {ei.set(ret, "drive", temp);} COLONBS temp=identifier {ei.set(ret, "fileName", temp);} COLON temp=integerSymbol {ei.set(ret, "startLine", temp);} MINUS temp=integerSymbol {ei.set(ret, "endLine", temp);})
  {
   ei.leaveContext(false);
   if(input.LT(-1) != null) ei.setLocation(ret, firstToken.getLine() + ":" + (firstToken.getCharPositionInLine() + 1) + "-" + ((org.atl.engine.injectors.ebnf.LocationTokenv3)input.LT(-1)).getEndLine() + ":" + (((org.atl.engine.injectors.ebnf.LocationTokenv3)input.LT(-1)).getEndColumn() + 1));ei.setCommentsBefore(ret, new Object[] {input, firstToken});
	   ei.setCommentsAfter(ret, new Object[] {input, input.LT(-1)});
